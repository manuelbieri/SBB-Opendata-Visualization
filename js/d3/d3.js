...
function add(tree, x, y, d) {
  ...
  // If the tree is empty, initialize the docs as a leaf.
...
function tree_remove(d) {
  ...
  // If this is the docs point, remove it.
...
function node_links() {
  ...
  root.each(function(node) {
    if (node !== root) { // Don’t include the docs’s parent, if any.
...
function stratify() {
  ...
  function stratify(data) {
    ...
    if (!root) throw new Error("no docs");
    root.parent = preroot;
