...
function bubbleChart() {
    ...
    function showDetail(d) {
        ...
        document.getElementById("temperature").innerHTML = (d.lufttemperatur + ' ' + getUnit('Lufttemperatur', false));
        document.getElementById("humidity").innerHTML = (d.luftfeuchtigkeit + ' ' + getUnit('Luftfeuchtigkeit', false));
        document.getElementById("air_pressure").innerHTML = (d.luftdruck + ' ' + getUnit('Luftdruck', false));
